...
$App.w04g = localStorage.getItem("w04g");
$App.w04h = localStorage.getItem("w04h");};
$scope.Seaview_pageenter = function() {$App.wherebox01 = localStorage.getItem("wherebox01");
$App.where01 = localStorage.getItem("where01");
$App.w01a = localStorage.getItem("w01a");
$App.w01b = localStorage.getItem("w01b");
$App.w01c = localStorage.getItem("w01c");
...
$App.w04g = localStorage.getItem("w04g");
$App.w04h = localStorage.getItem("w04h");};
$scope.Tax1_pageenter = function() {$App.wherebox01 = localStorage.getItem("wherebox01");
$App.where01 = localStorage.getItem("where01");
$App.w01a = localStorage.getItem("w01a");
$App.w01b = localStorage.getItem("w01b");
$App.w01c = localStorage.getItem("w01c");
...
$scope.TextArea6_change = function() {localStorage.setItem("tax01a",$App.tax01a);};
$scope.TextArea7_change = function() {localStorage.setItem("tax01b",$App.tax01b);};
$scope.TextArea8_change = function() {localStorage.setItem("tax03a",$App.tax03a);};
$scope.SVGicon6_click = function() {$App.tax01b = $scope.Calculate($App.tax01b+"+1",-1);
localStorage.setItem("tax01b",$App.tax01b);
$App.taxtot = $scope.Calculate($App.tax01b+"+"+$App.tax02b+"+"+$App.tax03b,-1);};
$scope.SVGicon7_click = function() {$App.tax01b = $scope.Calculate($App.tax01b+"-1",-1);
localStorage.setItem("tax01b",$App.tax01b);
$App.taxtot = $scope.Calculate($App.tax01b+"+"+$App.tax02b+"+"+$App.tax03b,-1);};
