...
$App.ha1 = localStorage.getItem("ha1");
$App.ha2 = localStorage.getItem("ha2");
$App.ha3 = localStorage.getItem("ha3");
$App.ha4 = localStorage.getItem("ha4");
$App.ha5 = localStorage.getItem("ha5");
$App.ha6 = localStorage.getItem("ha6");
$App.ha7 = localStorage.getItem("ha7");
$App.ha8 = localStorage.getItem("ha8");
$App.ha9 = localStorage.getItem("ha9");
$App.ha10 = localStorage.getItem("ha10");
$App.ha11 = localStorage.getItem("ha11");
$App.ha12 = localStorage.getItem("ha12");
localStorage.setItem("versionr",$App.versionr);
$App.vnotes = localStorage.getItem("vnotes");
$App.gmsta = localStorage.getItem("gmsta");
...
$App.gmstg = localStorage.getItem("gmstg");
$App.gmsth = localStorage.getItem("gmsth");
$App.sixma = localStorage.getItem("sixma");
$App.taxtot = localStorage.getItem("taxtot");
$App.filter01 = localStorage.getItem("filter01");
$App.filter02 = localStorage.getItem("filter02");
$App.filter03 = localStorage.getItem("filter03");
$App.filter04 = localStorage.getItem("filter04");
$App.filter05 = localStorage.getItem("filter05");
$App.filter06 = localStorage.getItem("filter06");
$App.filter07 = localStorage.getItem("filter07");
$App.filter08 = localStorage.getItem("filter08");
$App.filter09 = localStorage.getItem("filter09");
$App.filter10 = localStorage.getItem("filter10");
$App.filter11 = localStorage.getItem("filter11");
$App.filter12 = localStorage.getItem("filter12");
$App.filter13 = localStorage.getItem("filter13");
$App.filter14 = localStorage.getItem("filter14");
$App.filter15 = localStorage.getItem("filter15");
$App.filter16 = localStorage.getItem("filter16");
$App.filter17 = localStorage.getItem("filter17");
$App.filter18 = localStorage.getItem("filter18");
$App.filter19 = localStorage.getItem("filter19");
$App.filter20 = localStorage.getItem("filter20");
$App.filter21 = localStorage.getItem("filter21");
$App.filter22 = localStorage.getItem("filter22");
$App.filter23 = localStorage.getItem("filter23");
$App.filter24 = localStorage.getItem("filter24");};
$scope.sixmonthfilter_pageenter = function() {$App.gmsta = localStorage.getItem("gmsta");
$App.gmstb = localStorage.getItem("gmstb");
$App.gmstc = localStorage.getItem("gmstc");
$App.gmstd = localStorage.getItem("gmstd");
$App.gmste = localStorage.getItem("gmste");
...
$App.gmstg = localStorage.getItem("gmstg");
$App.gmsth = localStorage.getItem("gmsth");};
$scope.GMST2_pageenter = function() {$App.gmsta = localStorage.getItem("gmsta");
$App.gmstb = localStorage.getItem("gmstb");
$App.gmstc = localStorage.getItem("gmstc");
$App.gmstd = localStorage.getItem("gmstd");
$App.gmste = localStorage.getItem("gmste");
...
$App.gmstg = localStorage.getItem("gmstg");
$App.gmsth = localStorage.getItem("gmsth");
$App.gmstaa = localStorage.getItem("gmstaa");
$App.gmstbb = localStorage.getItem("gmstbb");
$App.gmstcc = localStorage.getItem("gmstcc");
$App.gmstdd = localStorage.getItem("gmstdd");
$App.gmstee = localStorage.getItem("gmstee");
$App.gmstff = localStorage.getItem("gmstff");
$App.gmstgg = localStorage.getItem("gmstgg");
$App.gmsthh = localStorage.getItem("gmsthh");};
...
NeoApp.controller("NewLanding1_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 1;
$App.NAB.PageID = "NewLanding1";
...
$scope.Headline131_click = function() {$scope.GotoPage( "Version" );};
$scope.Headline141_click = function() {$App.tax01a = localStorage.getItem("tax01a");
$App.tax02a = localStorage.getItem("tax02a");
$App.tax03a = localStorage.getItem("tax03a");
$App.tax04a = localStorage.getItem("tax04a");
$scope.GotoPage( "Seaview" );};
$scope.Headline144_click = function() {$scope.GotoPage( "sixmonthfilter" );};
$scope.Headline146_click = function() {$scope.GotoPage( "home" );};
$scope.PushButton42_click = function() {window.open($App.ha1, "_blank");};
$scope.PushButton43_click = function() {window.open($App.ha2, "_blank");};
$scope.PushButton47_click = function() {window.open($App.ha3, "_blank");};
$scope.PushButton48_click = function() {window.open($App.ha4, "_blank");};
$scope.PushButton49_click = function() {window.open($App.ha5, "_blank");};
$scope.PushButton50_click = function() {window.open($App.ha6, "_blank");};
$scope.PushButton51_click = function() {window.open($App.ha7, "_blank");};
$scope.PushButton52_click = function() {window.open($App.ha8, "_blank");};
$scope.PushButton53_click = function() {window.open($App.ha9, "_blank");};
$scope.TextInput2_change = function() {localStorage.setItem("ha1",$App.ha1);};
$scope.TextInput3_change = function() {localStorage.setItem("ha2",$App.ha2);};
$scope.TextInput4_change = function() {localStorage.setItem("ha3",$App.ha3);};
$scope.TextInput5_change = function() {localStorage.setItem("ha4",$App.ha4);};
$scope.TextInput6_change = function() {localStorage.setItem("ha5",$App.ha5);};
$scope.TextInput7_change = function() {localStorage.setItem("ha6",$App.ha6);};
$scope.TextInput8_change = function() {localStorage.setItem("ha7",$App.ha7);};
$scope.TextInput9_change = function() {localStorage.setItem("ha8",$App.ha8);};
$scope.TextInput10_change = function() {localStorage.setItem("ha9",$App.ha9);};
$scope.TextInput11_change = function() {localStorage.setItem("ha10",$App.ha10);};
$scope.TextInput12_change = function() {localStorage.setItem("ha11",$App.ha11);};
$scope.TextInput13_change = function() {localStorage.setItem("ha12",$App.ha12);};
$scope.PushButton54_click = function() {window.open($App.ha10, "_blank");};
$scope.PushButton55_click = function() {window.open($App.ha11, "_blank");};
$scope.PushButton56_click = function() {window.open($App.ha12, "_blank");};
$scope.TextInput14_change = function() {localStorage.setItem("h1",$App.h1);};
$scope.TextInput15_change = function() {localStorage.setItem("h2",$App.h2);};
$scope.TextInput16_change = function() {localStorage.setItem("h3",$App.h3);};
$scope.TextInput34_change = function() {localStorage.setItem("h4",$App.h4);};
$scope.TextInput35_change = function() {localStorage.setItem("h5",$App.h5);};
$scope.TextInput36_change = function() {localStorage.setItem("h6",$App.h6);};
$scope.TextInput37_change = function() {localStorage.setItem("h7",$App.h7);};
$scope.TextInput41_change = function() {localStorage.setItem("h8",$App.h8);};
$scope.TextInput42_change = function() {localStorage.setItem("h9",$App.h9);};
$scope.TextInput43_change = function() {localStorage.setItem("h10",$App.h10);};
$scope.TextInput44_change = function() {localStorage.setItem("h11",$App.h11);};
$scope.TextInput45_change = function() {localStorage.setItem("h12",$App.h12);};
});
NeoApp.controller("sixmonthfilter_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 2;
$App.NAB.PageID = "sixmonthfilter";
$scope.SVGicon34_click = function() {$scope.GotoPage( "home" );};
$scope.SVGicon35_click = function() {window.document.location.reload();};
$scope.SVGicon38_click = function() {$scope.PlaySound($App.ping,true);};
$scope.SVGicon39_click = function() {$scope.GotoPage( "LooseEnds" );};
$scope.Headline129_click = function() {$App.tax01a = localStorage.getItem("tax01a");
$App.tax02a = localStorage.getItem("tax02a");
$App.tax03a = localStorage.getItem("tax03a");
$App.tax04a = localStorage.getItem("tax04a");
$scope.GotoPage( "Seaview" );};
...
$scope.Headline130_click = function() {$scope.GotoPage( "NewLanding1" );};
$scope.TextArea50_change = function() {localStorage.setItem("sixma",$App.sixma);};
$scope.TextArea51_change = function() {localStorage.setItem("filter13",$App.filter13);};
$scope.TextArea52_change = function() {localStorage.setItem("filter14",$App.filter14);};
$scope.TextArea53_change = function() {localStorage.setItem("filter15",$App.filter15);};
$scope.TextArea54_change = function() {localStorage.setItem("filter16",$App.filter16);};
$scope.TextArea55_change = function() {localStorage.setItem("filter20",$App.filter20);};
$scope.TextArea56_change = function() {localStorage.setItem("filter17",$App.filter17);};
$scope.TextArea57_change = function() {localStorage.setItem("filter18",$App.filter18);};
$scope.TextArea58_change = function() {localStorage.setItem("filter19",$App.filter19);};
$scope.TextArea59_change = function() {localStorage.setItem("filter24",$App.filter24);};
$scope.TextArea60_change = function() {localStorage.setItem("filter21",$App.filter21);};
$scope.TextArea61_change = function() {localStorage.setItem("filter22",$App.filter22);};
$scope.TextArea62_change = function() {localStorage.setItem("filter23",$App.filter23);};
$scope.TextArea63_change = function() {localStorage.setItem("filter12",$App.filter12);};
$scope.TextArea64_change = function() {localStorage.setItem("filter11",$App.filter11);};
$scope.TextArea65_change = function() {localStorage.setItem("filter10",$App.filter10);};
$scope.TextArea66_change = function() {localStorage.setItem("filter09",$App.filter09);};
$scope.TextArea67_change = function() {localStorage.setItem("filter08",$App.filter08);};
$scope.TextArea68_change = function() {localStorage.setItem("filter07",$App.filter07);};
$scope.TextArea69_change = function() {localStorage.setItem("filter06",$App.filter06);};
$scope.TextArea70_change = function() {localStorage.setItem("filter05",$App.filter05);};
$scope.TextArea71_change = function() {localStorage.setItem("filter04",$App.filter04);};
$scope.TextArea72_change = function() {localStorage.setItem("filter03",$App.filter03);};
$scope.TextArea73_change = function() {localStorage.setItem("filter02",$App.filter02);};
$scope.TextArea74_change = function() {localStorage.setItem("filter01",$App.filter01);};
});
NeoApp.controller("GMST2_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 3;
$App.NAB.PageID = "GMST2";
$scope.SVGicon30_click = function() {$scope.GotoPage( "home" );};
$scope.SVGicon31_click = function() {window.document.location.reload();};
$scope.SVGicon32_click = function() {$scope.PlaySound($App.ping,true);};
$scope.NumericInput9_change = function() {localStorage.setItem("tax03b",$App.tax03b);};
$scope.SVGicon33_click = function() {$scope.GotoPage( "LooseEnds" );};
$scope.Headline127_click = function() {$App.tax01a = localStorage.getItem("tax01a");
$App.tax02a = localStorage.getItem("tax02a");
$App.tax03a = localStorage.getItem("tax03a");
$App.tax04a = localStorage.getItem("tax04a");
$scope.GotoPage( "Seaview" );};
$scope.TextArea36_change = function() {localStorage.setItem("gmsta",$App.gmsta);};
$scope.TextArea37_change = function() {localStorage.setItem("gmstb",$App.gmstb);};
$scope.TextArea38_change = function() {localStorage.setItem("gmstc",$App.gmstc);};
$scope.Pager5_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager5_nextclick = function() {$scope.GotoNextPage();};
$scope.TextArea39_change = function() {localStorage.setItem("gmstd",$App.gmstd);};
$scope.TextArea40_change = function() {localStorage.setItem("gmste",$App.gmste);};
$scope.TextArea41_change = function() {localStorage.setItem("gmstf",$App.gmstf);};
$scope.TextArea42_change = function() {localStorage.setItem("gmstg",$App.gmstg);};
$scope.TextArea43_change = function() {localStorage.setItem("gmsth",$App.gmsth);};
$scope.Headline128_click = function() {$scope.GotoPage( "NewLanding1" );};
$scope.PushButton41_click = function() {$scope.GotoPage( "NewLanding1" );};
$scope.TextArea33_change = function() {localStorage.setItem("gmstaa",$App.gmstaa);};
$scope.TextArea34_change = function() {localStorage.setItem("gmstaa",$App.gmstaa);};
$scope.TextArea35_change = function() {localStorage.setItem("gmstbb",$App.gmstbb);};
$scope.TextArea44_change = function() {localStorage.setItem("gmstcc",$App.gmstcc);};
$scope.TextArea45_change = function() {localStorage.setItem("gmstdd",$App.gmstdd);};
$scope.TextArea46_change = function() {localStorage.setItem("gmstee",$App.gmstee);};
$scope.TextArea47_change = function() {localStorage.setItem("gmstff",$App.gmstff);};
$scope.TextArea48_change = function() {localStorage.setItem("gmstgg",$App.gmstgg);};
$scope.TextArea49_change = function() {localStorage.setItem("gmsthh",$App.gmsthh);};
});
...
$scope.Headline142_click = function() {$scope.GotoPage( "NewLanding1" );};
});
...
$App.tax04b = localStorage.getItem("tax04b");
$scope.GotoPage( "Seaview" );};
$scope.Headline125_click = function() {$scope.GotoPage( "NewLanding1" );};
...
$scope.Headline143_click = function() {$scope.GotoPage( "NewLanding1" );};
});
...
$scope.TextArea75_change = function() {localStorage.setItem("vnotes",$App.vnotes);};
$scope.SVGicon40_click = function() {$scope.GotoPage( "NewLanding1" );};
});
