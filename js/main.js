...
$scope.Tax2_pageenter = function() {$App.wherebox01 = localStorage.getItem("wherebox01");
$App.where01 = localStorage.getItem("where01");
$App.w01a = localStorage.getItem("w01a");
$App.w01b = localStorage.getItem("w01b");
$App.w01c = localStorage.getItem("w01c");
...
$App.w04g = localStorage.getItem("w04g");
$App.w04h = localStorage.getItem("w04h");};
$scope.Tax3_pageenter = function() {$App.wherebox01 = localStorage.getItem("wherebox01");
$App.where01 = localStorage.getItem("where01");
$App.w01a = localStorage.getItem("w01a");
$App.w01b = localStorage.getItem("w01b");
$App.w01c = localStorage.getItem("w01c");
...
$scope.TextArea16_change = function() {localStorage.setItem("tax02a",$App.tax02a);};
$scope.TextArea21_change = function() {localStorage.setItem("tax02b",$App.tax02b);};
$scope.TextArea26_change = function() {localStorage.setItem("tax03a",$App.tax03a);};
$scope.SVGicon11_click = function() {$App.tax02b = $scope.Calculate($App.tax02b+"+1",-1);
localStorage.setItem("tax02b",$App.tax02b);
$App.taxtot = $scope.Calculate($App.tax01b+"+"+$App.tax02b+"+"+$App.tax03b,-1);};
$scope.SVGicon12_click = function() {$App.tax02b = $scope.Calculate($App.tax02b+"-1",-1);
localStorage.setItem("tax02b",$App.tax02b);
$App.taxtot = $scope.Calculate($App.tax01b+"+"+$App.tax02b+"+"+$App.tax03b,-1);};
$scope.Headline62_click = function() {$App.tax01a = localStorage.getItem("tax01a");
$App.tax02a = localStorage.getItem("tax02a");
$App.tax03a = localStorage.getItem("tax03a");
$App.tax04a = localStorage.getItem("tax04a");
$scope.GotoPage( "Seaview" );};
...
$App.NAB.PageID = "Tax3";
$scope.SVGicon17_click = function() {$scope.GotoPage( "home" );};
$scope.TextArea27_change = function() {localStorage.setItem("tax03a",$App.tax03a);};
$scope.TextArea28_change = function() {localStorage.setItem("tax03b",$App.tax03b);};
$scope.TextArea29_change = function() {localStorage.setItem("tax03a",$App.tax03a);};
$scope.SVGicon18_click = function() {$App.tax03b = $scope.Calculate($App.tax03b+"+1",-1);
localStorage.setItem("tax03b",$App.tax03b);
$App.taxtot = $scope.Calculate($App.tax01b+"+"+$App.tax02b+"+"+$App.tax03b,-1);};
$scope.SVGicon19_click = function() {$App.tax03b = $scope.Calculate($App.tax03b+"-1",-1);
localStorage.setItem("tax03b",$App.tax03b);
$App.taxtot = $scope.Calculate($App.tax01b+"+"+$App.tax02b+"+"+$App.tax03b,-1);};
$scope.Headline100_click = function() {$App.tax01a = localStorage.getItem("tax01a");
$App.tax02a = localStorage.getItem("tax02a");
$App.tax03a = localStorage.getItem("tax03a");
$App.tax04a = localStorage.getItem("tax04a");
$scope.GotoPage( "Seaview" );};
