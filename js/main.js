...
$scope.NewLanding1_pageenter = function() {$App.versionr = "V.02";
...
$scope.Image5_click = function() {$scope.GotoPage( "GMST2" );};
...
$scope.Rectangle1_click = function() {$scope.GotoPage( "sixmonthfilter" );};
